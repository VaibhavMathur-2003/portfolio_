...
export default function RootLayout({
  ...
  return (
    <html lang="en w-screen">
      ...
      <div className="container mx-auto flex h-12 max-w-7xl items-center justify-between">
        <Link href="#" className="flex items-center gap-2" prefetch={false}>
          <span className="text-lg font-semibold">Portfolio</span>
        </Link>
        <nav className="hidden items-center gap-6 bg-black p-3 px-6 border border-white rounded-full text-sm font-medium md:flex">
          <Link
            href="/"
