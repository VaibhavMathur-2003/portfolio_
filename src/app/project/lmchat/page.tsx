...
const timeline = [
  {
    ...
    description: "WebSocket-driven live updates ensure conversations stay synchronized for all users and LLMs.",
    icon: Zap,
    color: "from-purple-500 to-violet-600",
  },
  {
    title: "LLM Integration",
    description: "Add multiple LLMs to group chats for dynamic, AI-assisted discussions and problem-solving.",
    icon: Brain,
    color: "from-teal-500 to-cyan-600",
  },
  {
    title: "Smart Messaging",
    description: "Send messages to users, specific LLMs, or all LLMs, allowing for precise communication.",
    icon: Rocket,
    color: "from-indigo-500 to-blue-600",
  },
  {
    title: "Scalable Backend",
    description: "Built with Node.js, WebSockets, and Postgres, ensuring high availability and scalability.",
    icon: CheckCircle,
    ...
    <div className="flex flex-col text-white overflow-hidden bg-black">
        ...
        titleComponent={
          <>
            <h1 className="text-center text-4xl md:text-6xl font-extrabold tracking-tight leading-tight bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-transparent bg-clip-text">
                AI Brainstormer For Your Team
            </h1>
            <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-xl mx-auto">
              Make groups. Discuss ideas with friends and LLMs
            </p>
          </>
        }
      >
      ...
      <section className="relative z-10 w-full max-w-7xl mx-auto px-4 py-24">
        <div className="text-center mb-16">
          <Link
            href="https://github.com/VaibhavMathur-2003/chatlm"
          ...
          >
            <span className="relative z-10 text-xl text-white">Visit GitHub (Not Live Yet 😅)</span>
      ...
      <section className="w-full py-24 px-6 sm:px-8 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-12 lg:gap-16">
            {["/lmchat1.png", "/lmchat2.png", "/lmchat3.png"].map((src, index) => (
