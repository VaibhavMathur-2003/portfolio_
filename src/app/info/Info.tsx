    ...
    description: (
      <>
        <div className="space-y-4">
          <p>
            <span className="font-bold text-2xl text-red-400">•</span> I&apos;ve
            always been fascinated by the limitless possibilities that
            technology offers. As a &nbsp;
          ...
          <p>
            <span className="font-bold text-2xl text-yellow-400">•</span> From
            building dynamic web applications to mastering backend development,
            I&apos;ve had the chance to work on a variety of projects.
          </p>
          <p>
            <span className="font-bold text-2xl text-green-400">•</span> My
            experiences in startups have provided me with valuable insights into
            the real-world challenges and opportunities in the tech industry.
          </p>
          <p>
            <span className="font-bold text-2xl text-blue-400">•</span> Beyond
            the digital realm, I find inspiration in my hobbies. Whether
            it&apos;s strumming my guitar, playing football, or exploring new
            places, these experiences fuel my creativity.
          </p>
        </div>
      </>
    ),
        ...
        <div className="space-y-2">
          <ul className="list-disc list-inside space-y-1">
            <div>
              ...
              <span className="font-semibold">React</span> – Building dynamic
              and interactive web applications.
            </div>
            <div>
              <span className="font-bold text-2xl text-yellow-400">•</span>{" "}
              <span className="font-semibold">Next.js</span> – Server-side
              rendering and static site generation.
            </div>
            <div>
              <span className="font-bold text-2xl text-green-400">•</span>{" "}
              <span className="font-semibold">Node.js</span> – Developing
              scalable backend services using JavaScript runtime.
            </div>
            <div>
              <span className="font-bold text-2xl text-blue-400">•</span>{" "}
              <span className="font-semibold">Express</span> – Building fast and
              lightweight web APIs and microservices.
            </div>
            <div>
              <span className="font-bold text-2xl text-red-400">•</span>{" "}
              <span className="font-semibold">Redux</span> – State management
              for JavaScript apps, enhancing data flow and consistency.
            </div>
            <div>
              <span className="font-bold text-2xl text-yellow-400">•</span>{" "}
              <span className="font-semibold">MongoDB</span> – NoSQL database
              management for handling unstructured data.
            </div>
            <div>
              <span className="font-bold text-2xl text-green-400">•</span>{" "}
              <span className="font-semibold">PostgreSQL</span> – Managing
              relational databases for complex data structures.
            </div>
            <div>
              <span className="font-bold text-2xl text-blue-400">•</span>{" "}
              <span className="font-semibold">Docker</span> – Containerizing
              applications for consistency across environments.
            </div>
            <div>
              <span className="font-bold text-2xl text-red-400">•</span>{" "}
              <span className="font-semibold">JavaScript</span> – Core language
              for building frontend and backend applications.
            </div>
            <div>
              <span className="font-bold text-2xl text-yellow-400">•</span>{" "}
              <span className="font-semibold">TypeScript</span> – Typed superset
            ...
            <div>
              <span className="font-bold text-2xl text-blue-400">•</span>{" "}
              <span className="font-semibold">Prisma</span> – Next-gen ORM for
              interacting with databases in a type-safe way.
            </div>
            <div>
              <span className="font-bold text-2xl text-red-400">•</span>{" "}
              <span className="font-semibold">GraphQL</span> – Query language
              for efficient data fetching and API interactions.
            </div>
            <div>
              <span className="font-bold text-2xl text-yellow-400">•</span>{" "}
              <span className="font-semibold">Git</span> – Version control for
              collaboration and project management.
            </div>
            <div>
              <span className="font-bold text-2xl text-green-400">•</span>{" "}
              <span className="font-semibold">Linux</span> – Proficiency in
          ...
          <div className="space-y-6">
            ...
            <div>
              <p className="font-semibold">
                ...
                Core Member of College Web Club
              </p>
              <p className="text-sm text-gray-200">
